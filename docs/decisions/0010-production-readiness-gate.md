...
5. Promotion and rollback workflows must call `release:promotion-policy-verify` and reject named-party publication
   unless `publication_legal_review` is accepted.
6. Commercial SLAs, self-service checkout, and billed plan prices are not public claims until billing and
